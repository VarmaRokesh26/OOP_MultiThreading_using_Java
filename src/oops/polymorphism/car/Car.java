...
public abstract class Car {
    ...
    public void getDescription() {
        System.out.println("A " + color + " "+ carName +" Dodge Challenger is created.");
    ...
    public void drive(int mileage) {
        ...
        System.out.println("int parametrized function is  called");
    }
    
    public void drive(double mileage) {
        this.mileage += (int)Math.abs(Math.round(mileage));
        System.out.println("double parametrized function is  called");
    }
